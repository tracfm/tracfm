...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PollResponse.message'
        db.alter_column('polls_pollresponse', 'message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms_httprouter.Message'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PollResponse.message'
        raise RuntimeError("Cannot reverse this migration. 'PollResponse.message' and its values cannot be restored.")
