...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TracSettings.trac_reset_response'
        db.add_column('polls_tracsettings', 'trac_reset_response', self.gf('django.db.models.fields.CharField')(default='Your TracFM profile has been reset.', max_length=160), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TracSettings.trac_reset_response'
        db.delete_column('polls_tracsettings', 'trac_reset_response')
