...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poll.backend'
        db.add_column('polls_poll', 'backend',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['rapidsms.Backend']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poll.backend'
        db.delete_column('polls_poll', 'backend_id')
