...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Poll.keyword'
        db.delete_column('polls_poll', 'keyword')


    def backwards(self, orm):
        
        # Adding field 'Poll.keyword'
        db.add_column('polls_poll', 'keyword', self.gf('django.db.models.fields.SlugField')(default='', max_length=32, blank=True, db_index=True), keep_default=False)
