...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.backend'
        db.alter_column('polls_poll', 'backend_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Backend'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Poll.backend'
        raise RuntimeError("Cannot reverse this migration. 'Poll.backend' and its values cannot be restored.")
