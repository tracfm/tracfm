...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PollCategorySet.is_public'
        db.add_column('polls_pollcategoryset', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PollCategorySet.is_public'
        db.delete_column('polls_pollcategoryset', 'is_public')
