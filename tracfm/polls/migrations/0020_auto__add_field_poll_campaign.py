...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poll.campaign'
        db.add_column('polls_poll', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_quickblocks.QuickBlock'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poll.campaign'
        db.delete_column('polls_poll', 'campaign_id')
