...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TracSettings'
        db.create_table('polls_tracsettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trac_on_response', self.gf('django.db.models.fields.CharField')(max_length=160)),
            ('trac_off_response', self.gf('django.db.models.fields.CharField')(max_length=160)),
            ('recruitment_message', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('duplicate_message', self.gf('django.db.models.fields.CharField')(max_length=160)),
        ))
        db.send_create_signal('polls', ['TracSettings'])

        # Adding model 'Poll'
        db.create_table('polls_poll', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('keyword', self.gf('django.db.models.fields.SlugField')(default='', max_length=32, db_index=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('unknown_message', self.gf('django.db.models.fields.CharField')(max_length=160)),
            ...
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='template', null=True, to=orm['polls.PollCategorySet'])),
            ('secondary_template', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='secondary_template', null=True, to=orm['polls.PollCategorySet'])),
            ('category_set', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_set', null=True, to=orm['polls.PollCategorySet'])),
            ('secondary_category_set', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='secondary_category_set', null=True, to=orm['polls.PollCategorySet'])),
        ...
        # Adding model 'PollCategorySet'
        db.create_table('polls_pollcategoryset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('polls', ['PollCategorySet'])

        # Adding model 'PollCategory'
        db.create_table('polls_pollcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('category_set', self.gf('django.db.models.fields.related.ForeignKey')(related_name='categories', to=orm['polls.PollCategorySet'])),
            ('latitude', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('longitude', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal('polls', ['PollCategory'])

        # Adding unique constraint on 'PollCategory', fields ['name', 'category_set']
        db.create_unique('polls_pollcategory', ['name', 'category_set_id'])

        # Adding model 'PollRule'
        db.create_table('polls_pollrule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rules', to=orm['polls.PollCategory'])),
            ('match', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('numeric', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('lower_bound', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('upper_bound', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('polls', ['PollRule'])

        # Adding model 'Respondent'
        db.create_table('polls_respondent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('active_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('last_response', self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_respondent', null=True, to=orm['polls.PollResponse'])),
        ))
        db.send_create_signal('polls', ['Respondent'])

        # Adding model 'PollResponse'
        db.create_table('polls_pollresponse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(related_name='responses', to=orm['polls.Poll'])),
            ('respondent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='responses', to=orm['polls.Respondent'])),
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='primary_responses', null=True, to=orm['polls.PollCategory'])),
            ('secondary_category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='secondary_responses', null=True, to=orm['polls.PollCategory'])),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('polls', ['PollResponse'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PollCategory', fields ['name', 'category_set']
        db.delete_unique('polls_pollcategory', ['name', 'category_set_id'])

        # Deleting model 'TracSettings'
        db.delete_table('polls_tracsettings')

        # Deleting model 'Poll'
        db.delete_table('polls_poll')

        # Deleting model 'PollCategorySet'
        db.delete_table('polls_pollcategoryset')

        # Deleting model 'PollCategory'
        db.delete_table('polls_pollcategory')

        # Deleting model 'PollRule'
        db.delete_table('polls_pollrule')

        # Deleting model 'Respondent'
        db.delete_table('polls_respondent')

        # Deleting model 'PollResponse'
        db.delete_table('polls_pollresponse')
