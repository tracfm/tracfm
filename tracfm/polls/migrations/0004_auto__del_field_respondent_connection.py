...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Respondent.connection'
        db.delete_column('polls_respondent', 'connection_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Respondent.connection'
        raise RuntimeError("Cannot reverse this migration. 'Respondent.connection' and its values cannot be restored.")
