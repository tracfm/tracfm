...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Poll.audio_file'
        db.add_column('polls_poll', 'audio_file', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Poll.audio_file'
        db.delete_column('polls_poll', 'audio_file')
