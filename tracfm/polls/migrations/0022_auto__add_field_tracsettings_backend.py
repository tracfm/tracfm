...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TracSettings.backend'
        db.add_column('polls_tracsettings', 'backend',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Backend'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TracSettings.backend'
        db.delete_column('polls_tracsettings', 'backend_id')
    ...
    models = {
        ...
        'polls.poll': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'polls'", 'null': 'True', 'to': "orm['django_quickblocks.QuickBlock']"}),
        ...
        'polls.tracsettings': {
            ...
            'backend': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rapidsms.Backend']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
