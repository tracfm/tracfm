...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Poll.always_update'
        db.add_column('polls_poll', 'always_update', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding index on 'Respondent', fields ['identity']
        db.create_index('polls_respondent', ['identity'])


    def backwards(self, orm):
        
        # Removing index on 'Respondent', fields ['identity']
        db.delete_index('polls_respondent', ['identity'])

        # Deleting field 'Poll.always_update'
        db.delete_column('polls_poll', 'always_update')
