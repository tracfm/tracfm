...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PollKeyword'
        db.create_table('polls_pollkeyword', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(related_name='keywords', to=orm['polls.Poll'])),
        ))
        db.send_create_signal('polls', ['PollKeyword'])


    def backwards(self, orm):
        
        # Deleting model 'PollKeyword'
        db.delete_table('polls_pollkeyword')
