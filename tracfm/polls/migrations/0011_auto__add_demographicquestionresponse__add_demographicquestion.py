...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DemographicQuestionResponse'
        db.create_table('polls_demographicquestionresponse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='answers', to=orm['polls.DemographicQuestion'])),
            ('respondent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='question_answers', to=orm['polls.Respondent'])),
            ('response', self.gf('django.db.models.fields.TextField')(max_length=255)),
        ))
        db.send_create_signal('polls', ['DemographicQuestionResponse'])

        # Adding model 'DemographicQuestion'
        db.create_table('polls_demographicquestion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demographicquestion_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demographicquestion_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal('polls', ['DemographicQuestion'])


    def backwards(self, orm):
        
        # Deleting model 'DemographicQuestionResponse'
        db.delete_table('polls_demographicquestionresponse')

        # Deleting model 'DemographicQuestion'
        db.delete_table('polls_demographicquestion')
